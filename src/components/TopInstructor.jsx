...
const TopInstructor = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <h2 className="bg-linear-to-tr from-black via-blue-800 to-blue-500 bg-clip-text text-transparent text-3xl font-extrabold py-4 text-center">Popular Instructor</h2>
